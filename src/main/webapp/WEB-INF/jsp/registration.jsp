...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="userForm" class="form-signin" accept-charset="utf-8">
        ...
        <spring:bind path="name2">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="name2" class="form-control" placeholder="Second Name"
                            autofocus="true"></form:input>
        ...
        <spring:bind path="surname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="surname" class="form-control" placeholder="Family Name"
                            autofocus="true"></form:input>
